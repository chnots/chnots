...
CREATE TABLE
    IF NOT EXISTS toent_event_hist (
        otid BIGINT NOT NULL,
        event_defi TEXT NOT NULL,
        tid BIGINT NOT NULL,
        UNIQUE (tid)
