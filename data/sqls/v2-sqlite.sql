...
create table
  llm_chat_record_hist (
    otid number not null,
    session_otid number not null,
    pre_record_otid number,
    content TEXT not null,
...
select
  ...
  kind,
  tid,
  unixepoch ('epoch', archive_time) * 1000000
from
